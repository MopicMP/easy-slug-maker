...
> Easy convert any string to url-safe slug

[![PyPI version](https://badge.fury.io/py/easy-slug-maker.svg)](https://pypi.org/project/easy-slug-maker/)
...
result = maker("Hello World")

# Example 2: Batch processing
from easy_slug_maker import batch
